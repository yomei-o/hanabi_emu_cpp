...
| **渦蜂** | ×0.34 | ×1.85 | ×1.10 | 回転軸を玉全体で揃えた蜂。巨大な風車を描く |
...
#### 渦蜂 — 蜂のもう一種類
同じ推力の仕組みだが、**回転軸を玉全体で共有**し、**回転の向きも速さも揃える**。
そのうえで推力を強く（95〜150 m/s²）、回転をゆっくり（1.15〜2.0 rad/s）にする。
渦の半径はだいたい **推力 ÷ 角速度²** なので、蜂の 5m 級に対して渦蜂は 40m 級の巨大な弧になる。
全部の星が同じ向きに巻くので、空一面の風車になる。星数はさらに減らして（×0.24）軌跡を見せる。
...
./hanabi 500 hachi.png 0 3        # 5番目の引数 = 玉の種類(-1おまかせ 0菊 1牡丹 2柳 3蜂 4千輪 5♡ 6輪 7土星)
```
