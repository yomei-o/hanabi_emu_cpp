...
| **渦蜂** | ×0.82 | ×1.75 | ×1.10 | 回転軸を玉全体で揃えた蜂。細かく速く巻きながら飛ぶ |
...
そのうえで推力をうんと強く（230〜420 m/s²）、回転を速く（5.0〜7.5 rad/s ≒ 1回転/秒）にする。

渦の半径はだいたい **推力 ÷ 角速度²**。速く回すぶん半径は数m〜10m に締まり、
飛翔速度（割薬による初速）は ×0.82 と高いままなので、**細かく速く巻きながら遠くまで飛ぶ**。
全部の星が同じ向きに巻くので、渦の向きが揃った独特の絵になる。
